...
class TechnicienController extends Controller
{
    ...
    public function create()
    {
       // $specialites = Specialite::all();
        ...
        return view('services.techniciens.create', compact( 'users'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $customMessages = [
            'tele.required' => 'The phone number field is required.',
            'specialites.required' => 'The specialty field is required.',
       ...
       // $Technicien->specialite_id = $request->input('specialites');
        ...
        $specialty =new Specialite;
        $specialty->specialite= $request->input('specialites');
        $specialty->save();

        $Technicien->specialite_id=$specialty->id;
        //Image Treatment
