...
@section('content')
    <div class="content-wrapper">
        <!-- Main content -->
        <h1 class="mt-5 ml-5">Here are the technicians :</h1>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="card card-primary card-outline relative" style="display:flex">
                                <div style="position:absolute;top:10px;right:10px;">
                                    <form onsubmit="confirm('êAre you sure you want to delete this item')"
...
<!--                                    <ul class="list-group list-group-bordered mb-3">
                                        ...
                                        <li class="list-group-item">
                                            <b>The Completed Task</b> <a class="float-right">13,287</a>
                                        </li>
                                    </ul>-->
<!--                                    <a href="{{ '/services/technicien/mailForm/' . $tech->id }}"
                                        class="btn btn-primary btn-block"><b>Contact</b>
                                    </a>-->
                                </div>
                                <!-- /.card-body -->
                            </div>
